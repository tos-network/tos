...
// Contract paths
const V0_CONTRACT_PATH: &str = "tests/fixtures/hello_world_v0.so"; // e_flags=0 (built with --arch v0)
const V3_CONTRACT_PATH: &str = "tests/fixtures/hello_world.so"; // e_flags=3 (built with --arch v3)
