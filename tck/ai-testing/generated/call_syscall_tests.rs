...
fn compute_create_address(sender: &Address, nonce: u64) -> Address {
    ...
    unimplemented!("Use actual implementation")
}

fn compute_create2_address(sender: &Address, salt: [u8; 32], init_code: &[u8]) -> Address {
    // keccak256(0xff ++ sender ++ salt ++ keccak256(init_code))[12:]
    unimplemented!("Use actual implementation")
}

fn encode_set_storage(key: [u8; 32], value: [u8; 32]) -> Vec<u8> {
    unimplemented!()
}

fn encode_write_storage() -> Vec<u8> {
    unimplemented!()
}

fn encode_transfer() -> Vec<u8> {
    unimplemented!()
}

fn encode_emit_log() -> Vec<u8> {
    unimplemented!()
}

fn encode_create() -> Vec<u8> {
    unimplemented!()
}

fn encode_selfdestruct() -> Vec<u8> {
    unimplemented!()
}
