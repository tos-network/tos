...
use crate::{
    crypto::{
        elgamal::{
            Ciphertext, DecompressionError, PedersenCommitment, PedersenOpening, PublicKey,
...
impl CommitmentEqProof {
    ...
    pub fn new_with_scalar(
        ...
        let Y_1 = RistrettoPoint::multiscalar_mul([&y_x, &y_s], [&G, D_source]).compress();
    ...
    pub fn pre_verify(
        ...
        let Y_2 = self.Y_2.decompress().ok_or(DecompressionError)?;
