...
/// Maximum offer amount (1 trillion atomic units = 10,000 TOS at 8 decimals)
/// Prevents integer overflow in priority calculations and excessive value transfers
pub const MAX_OFFER_AMOUNT: u64 = 1_000_000_000_000;

// ============================================================================
// Input Data Limits
// ============================================================================

/// Maximum size of input_data for scheduled executions (64KB)
/// Prevents storage bloat and excessive memory usage
pub const MAX_INPUT_DATA_SIZE: usize = 64 * 1024;
...
/// Error: Input data exceeds maximum size (64KB)
pub const ERR_INPUT_TOO_LARGE: u64 = 13;

/// Error: Offer amount exceeds maximum allowed
pub const ERR_OFFER_TOO_HIGH: u64 = 14;
