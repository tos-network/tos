...
//
// TOS: 100 blocks @ 1 BPS = 100 seconds (~1.7 minutes)
// This value provides good balance between fast finality and network stability
pub const STABLE_LIMIT: u64 = 100;
