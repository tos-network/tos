use crate::core::{
    ...
    storage::{ContractOutputsProvider, SledStorage},
};
use async_trait::async_trait;
use tos_common::{contract::ContractOutput, crypto::Hash, serializer::Serializer};
...
impl ContractOutputsProvider for SledStorage {
    ...
    async fn get_contract_outputs_for_tx(
        ...
        self.load_from_disk(
            &self.contracts_outputs,
            tx_hash.as_bytes(),
            DiskContext::ContractOutputs,
        )
    }
