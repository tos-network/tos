use crate::core::{
    ...
    storage::{rocksdb::Column, RocksStorage, SupplyProvider},
};
...
impl SupplyProvider for RocksStorage {
    ...
    async fn get_asset_supply_at_maximum_topoheight(
        ...
        let mut prev_topo = if pointer > maximum_topoheight
            && self.contains_data(Column::VersionedAssetsSupply, &versioned_key)?
        {
