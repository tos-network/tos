...
impl ContractProvider for RocksStorage {
    ...
    async fn has_contract_module_at_topoheight(
        ...
        self.load_optional_from_disk::<_, (Option<TopoHeight>, bool)>(
...
impl RocksStorage {
    ...
    pub(super) fn get_optional_contract_id(
        &self,
        contract: &Hash,
    ...
    pub fn get_optional_contract_type(
        &self,
        contract: &Hash,
    ...
    pub(super) fn get_or_create_contract_type(
        &mut self,
        hash: &Hash,
