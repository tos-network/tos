use crate::core::{
    ...
    storage::{rocksdb::Column, NetworkProvider, NonceProvider, RocksStorage},
};
use async_trait::async_trait;
use log::trace;
use tos_common::{account::VersionedNonce, block::TopoHeight, crypto::PublicKey};
...
impl NonceProvider for RocksStorage {
    ...
    async fn set_last_nonce_to(
        ...
        self.insert_into_disk(
            Column::VersionedNonces,
            &Self::get_versioned_account_key(account.id, topoheight),
            nonce,
        )?;
