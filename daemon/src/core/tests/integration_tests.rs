...
mod integration_tests {
    ...
    fn test_blue_score_accumulation_in_chain() {
        ...
        chain_data.push(TosGhostdagData::new(
            0, BlueWorkType::zero(), genesis_hash.clone(),
