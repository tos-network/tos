...
use tos_common::{
    ...
    prompt::{
        ...
        default_logs_datetime_format, Color, LogLevel, ModuleConfig, Prompt, PromptConfig,
        PromptError, ShareablePrompt,
    },
...
async fn main() -> Result<()> {
    ...
    // Create RocksDB storage (the only supported backend)
