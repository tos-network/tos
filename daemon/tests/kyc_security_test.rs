...
mod security_attack_tests {
    ...
    /// Issue #1: RegisterCommittee approvals did not bind to committee configuration
    #[test]
    ...
    /// Issue #4: Stateful approval verification counts duplicate approvers
    #[test]
...
mod boundary_tests {
    ...
    /// Issue #2: TransferKyc does not enforce destination committee max_kyc_level
    #[test]
...
mod state_machine_tests {
    ...
    /// Issue #3: Dissolved committees can still issue EmergencySuspend approvals
    #[test]
...
mod determinism_tests {
    ...
    /// Issue #5: Member list order-sensitive
    #[test]
