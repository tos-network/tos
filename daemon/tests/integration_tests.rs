...
fn is_valid_fee_type_combination(tx_type: &TransactionType, fee_type: &FeeType) -> bool {
    match (tx_type, fee_type) {
        ...
        (TransactionType::AgentAccount(_), FeeType::TOS) => true,
        (TransactionType::AgentAccount(_), FeeType::Energy) => false,
        (TransactionType::AgentAccount(_), FeeType::UNO) => false,
        ...
        (TransactionType::SubmitVerdictByJuror(_), FeeType::TOS) => true,
        (TransactionType::SubmitVerdictByJuror(_), FeeType::Energy) => false,
        (TransactionType::SubmitVerdictByJuror(_), FeeType::UNO) => false,
        (TransactionType::CommitArbitrationOpen(_), FeeType::TOS) => true,
        (TransactionType::CommitArbitrationOpen(_), FeeType::Energy) => false,
        (TransactionType::CommitArbitrationOpen(_), FeeType::UNO) => false,
        (TransactionType::CommitVoteRequest(_), FeeType::TOS) => true,
        (TransactionType::CommitVoteRequest(_), FeeType::Energy) => false,
        (TransactionType::CommitVoteRequest(_), FeeType::UNO) => false,
        (TransactionType::CommitSelectionCommitment(_), FeeType::TOS) => true,
        (TransactionType::CommitSelectionCommitment(_), FeeType::Energy) => false,
        (TransactionType::CommitSelectionCommitment(_), FeeType::UNO) => false,
        (TransactionType::CommitJurorVote(_), FeeType::TOS) => true,
        (TransactionType::CommitJurorVote(_), FeeType::Energy) => false,
        (TransactionType::CommitJurorVote(_), FeeType::UNO) => false,
